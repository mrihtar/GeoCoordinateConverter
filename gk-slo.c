...
// Copyright (c) 2014 Matjaz Rihtar <matjaz@eunet.si>
// All rights reserved.
//
...
//
// Compile on Unix:
//   gcc: gcc -O2 -Wall gk-slo.c -o gk-slo -lm -lrt
// Compile on Windows:
//   MinGW: gcc -O2 -Wall gk-slo.c -o gk-slo.exe
//   MS C:  cl /O2 /Wall gk-slo.c
// Compile for profiler (gprof/AQTime):
//   gcc: gcc -g2 -gstabs+ -Wall gk-slo.c -o gk-slo.exe -pg
//       (run gk-slo.exe --> creates file gmon.out)
//        gprof gk-slo.exe gmon.out > gprof.txt
//   MS C: cl /Zi /DEBUG /Wall gk-slo.c
//
#ifdef _WIN32
...
#define SW_VERSION T("5.00")
#define SW_BUILD   T("Dec 23, 2014")
...
#endif
  // Trim whitespaces and dot from the end
  len = strlen(msg) - 1;
...
{
  fprintf(stderr, T("%s %s  Copyright (c) 2014 Matjaz Rihtar  (%s)\n"),
